module.exports = {
  cacheId: 'eluenttranslator',
  offlineGoogleAnalytics: true,
  cleanupOutdatedCaches: true,
  globDirectory: 'dist/',
  globPatterns: ['**/*.{css,js,json}'],
  swDest: 'dist/sw.js',
  skipWaiting: true, // Automatically update SW without asking, see more: https://www.smashingmagazine.com/2019/06/pwa-webpack-workbox/
  globIgnores: ['/thank-you'],
